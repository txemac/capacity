...
.PHONY: load-consumer-k8s create-model-secret run-consumer-k8s run-k8s build
...
run-k8s: run-producer-k8s create-model-secret build-consumer load-consumer-k8s run-consumer-k8s
